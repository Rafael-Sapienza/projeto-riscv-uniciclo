# 1. Inicia a simulação com as configurações do teste2
vsim -gROM_FILE="teste2/teste2_rom.txt" -gRAM_FILE="teste2/teste2_ram.txt" -gEXPECTED_FILE="teste2/expected2.txt" -gDUMP_FILE="teste2/teste2_ram_final.txt" -gCHECK_TAIL_ZERO=false work.tb_uRV
